...
directory = r"C:/Ocean/Chile/4_chlor/"
...
def ___Processing___():
    ...
    for filename in os.listdir(directory + "raw_files/"):
        if filename.endswith("nc"):
                ...
                df = df.drop(df[df.long < -75].index) #West
    ...
    df_final3.to_csv(directory + "Clorophyll.csv", index = False)
